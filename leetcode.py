...
while page in range(1, lastPage+1):     
    ...
    for e in tableRows:
        if(page ==1 and i ==1):
            i+=1
            continue
        problem_title = e.find_element(by=By.XPATH, value=".//div[2]/div/div/div/div/a")
        print(problem_title.text)
        problem_link = problem_title.get_attribute('href')
        print(problem_link)
        # time.sleep(2)
        difficulty = e.find_element(by=By.XPATH, value=".//div[5]")
        ...
        try:
            ...
            status = 'To do'
        print(status)
        problem_button = e.find_element(by=By.XPATH, value=".//div[2]/div/div/div")
        ...
        back_svg.click()
        # /html/body/div[1]/div/div/div/div/div/div[1]/div/div/div/div[2]/div/div[2]/div[1]/div[1]/div[1]/span
        # /html/body/div[1]/div/div/div/div/div/div[1]/div/div/div/div[2]/div/div[2]/div[1]/div[1]/div[1]/span
        # /html/body/div[1]/div/div/div/div/div/div[1]/div/div/div/div[2]/div/div[2]/div[2]/div[1]/div[1]/span
        # /html/body/div[1]/div/div/div/div/div/div[1]/div/div/div/div[2]/div/div[2]/div[8]/div[1]/div[1]/span
        
        # /html/body/div[1]/div/div/div/div/div/div[1]/div/div/div/div[2]/div/div[2]/div[1]/div[1]/div[1]/div/div/span
        # /html/body/div[1]/div/div/div/div/div/div[1]/div/div/div/div[2]/div/div[2]/div[1]/div[1]/div[1]/div/div/span
        # /html/body/div[1]/div/div/div/div/div/div[1]/div/div/div/div[2]/div/div[2]/div[2]/div[1]/div[1]/div/div/span
        
        # /html/body/div[1]/div/div[2]/div[1]/div[1]/div[6]/div[2]/div/div/div[2]/div[2]/div[2]/div/div/div
        # /html/body/div[1]/div/div[2]/div[1]/div[1]/div[6]/div[2]/div/div/div[2]/div[3]/div[2]/div/div/div
        i+=1
        time.sleep(3)
    if (page == lastPage):
        break
...
# /html/body/div[1]/div/div[2]/div[1]/div[1]/div[6]/div[3]/nav/button[10]